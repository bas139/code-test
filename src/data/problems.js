export const problemsData = [
  ...
  },
  {
    ...
    "diff": "Easy",
    "lang": "All Languages",
    "description_th": "รับขนาด N แล้วพิมพ์รูปสี่เหลี่ยมจัตุรัสที่มีลักษณะเป็นตารางหมากรุก (o และ x สลับกัน)\nโดยเริ่มด้วย 'o' ก่อนเสมอ\n\nข้อมูลนำเข้า:\nบรรทัดแรก: N (1 <= N <= 20)\n\nข้อมูลส่งออก:\nรูปตารางหมากรุกขนาด N x N",
    "description_en": "Print a checkerboard pattern of 'o' and 'x' of size N x N starting with 'o'.",
  ...
  },
  {
    ...
    "diff": "Easy",
    "lang": "All Languages",
    "description_th": "รับคะแนนจากผู้ใช้ (0 - 100) แล้วพิมพ์เกรดตามเงื่อนไขดังนี้:\n- 80-100: A\n- 70-79: B\n- 60-69: C\n- 50-59: D\n- ต่ำกว่า 50: F",
    "description_en": "Calculate grade based on score (A=80-100, B=70-79, C=60-69, D=50-59, F<50).",
  ...
  },
  {
    ...
    "diff": "Medium",
    "lang": "All Languages",
    "description_th": "ให้ข้อมูลพิกัด (L, H, R) ของตึกแต่ละตึก (เริ่มต้นด้านซ้ายที่ L สูง H และสิ้นสุดด้านขวาที่ R)\nจงแสดงผลลัพธ์เป็นพิกัดความสูงของเส้นขอบฟ้า (Skyline) ทั้งหมดเรียงจากซ้ายไปขวา\n\nข้อมูลนำเข้า:\nบรรทัดแรก: จำนวนตึก N\nอีก N บรรทัด: พิกัด L, H, R ของแต่ละตึก",
    "description_en": "Given N buildings with coordinates (L, H, R), print the skyline silhouette from left to right.",
    "hint_th": "เนื่องจากพิกัด L, R มีค่าไม่เกิน 255 สามารถใช้อาร์เรย์เก็บความสูงสูงสุดที่พิกัด X แต่ละจุดได้",
    "hint_en": "Since coordinates are small, use an array of size 256 to keep track of the maximum height at each x.",
    "testcases": [
      {
        "input": "2\n1 11 5\n2 6 7\n",
  ...
  },
  {
    ...
    "diff": "Medium",
    "lang": "All Languages",
    "description_th": "จงเขียนโปรแกรมหาค่า Fibonacci ตัวที่ N โดยกำหนดให้:\nF(1) = 1, F(2) = 1\nF(N) = F(N-1) + F(N-2)\n\nข้อมูลนำเข้า: ตัวเลข N (1 <= N <= 40)",
    "description_en": "Find the N-th Fibonacci number.",
    "hint_th": "สามารถใช้ Loop ธรรมดาหรือ Dynamic programming ได้ (ข้อนี้ N=40 ถ้าใช้ Recursion ธรรมดาอาจจะช้าเกินไป)",
  ...
  },
  {
    ...
    "diff": "Hard",
    "lang": "All Languages",
    "description_th": "ตารางขนาด M แถว N คอลัมน์ จำลองการเล่นเกมโดยมีการย้ายบล็อก ถ้ามีบล็อกสีเดียวกันเรียงติดกัน 3 ชิ้นทั้งแนวตั้งหรือแนวนอน บล็อกนั้นจะระเบิดและด้านบนจะร่วงลงมา \nจงรับคำสั่งเลื่อนบล็อก แล้วแสดงตารางหลังจากการระเบิดสิ้นสุดลง (แบบย่อ ให้แสดงจำนวนชิ้นที่ระเบิดก็พอ)",
    "description_en": "Simulate a block puzzle game and count the total number of blocks destroyed.",
  ...
  },
  {
    ...
    "diff": "Medium",
    "lang": "All Languages",
    "description_th": "รับจำนวนเต็ม N และอาเรย์ของตัวเลข N ตัว และรับเป้าหมาย K\nจงหาว่ามีกี่คู่ในอาเรย์ที่บวกกันแล้วได้เท่ากับ K พอดี\n\nข้อมูลนำเข้า:\nบรรทัดแรก: N K\nบรรทัดที่สอง: ตัวเลข N จำนวนคั่นด้วยช่องว่าง",
    "description_en": "Given an array of N integers and a target K, find the number of pairs that sum up to K.",
    "hint_th": "สามารถใช้ Hash Map (หรือ Dictionary/Unordered Map) เพื่อเช็คคู่ได้อย่างรวดเร็วใน O(N)",
  ...
  },
  {
    ...
    "diff": "Hard",
    "lang": "All Languages",
    "description_th": "รับข้อความ S จงหาความยาวของข้อความย่อย (Substring) ที่เป็น Palindrome ที่ยาวที่สุด\n(Palindrome คือข้อความที่อ่านจากหน้าไปหลัง หรือหลังมาหน้าแล้วเหมือนเดิม)",
    "description_en": "Find the length of the longest palindromic substring in S.",
  ...
  },
  {
    ...
    "diff": "Easy",
    "lang": "All Languages",
    "description_th": "รับคำ 2 คำ (บรรทัดละคำ) จงเช็คว่าคำสองคำนั้นประกอบขึ้นจากตัวอักษรชุดเดียวกันหรือไม่ (Anagram)\nถ้าใช่ให้พิมพ์ YES ถ้าไม่ใช่พิมพ์ NO (ตัวพิมพ์เล็ก-ใหญ่ถือว่าต่างกัน)",
    "description_en": "Check if two given strings are anagrams of each other. Print YES or NO.",
  ...
  },
  {
    ...
    "diff": "Easy",
    "lang": "All Languages",
    "description_th": "รับตัวเลขจำนวนเต็มบวก 1 ตัว จงตรวจสอบว่าเป็นจำนวนเฉพาะหรือไม่ \nตอบ 'Prime' ถ้าเป็นจำนวนเฉพาะ และ 'Not Prime' ถ้าไม่ใช่",
    "description_en": "Check if a given number is prime or not. Print 'Prime' or 'Not Prime'.",
    "hint_th": "จำนวนเฉพาะคือจำนวนที่มีแค่ 1 และตัวมันเองหารลงตัว ลองลูปเช็คตัวหารตั้งแต่ 2 ถึง sqrt(N)",
  ...
  },
  {
    ...
    "diff": "Easy",
    "lang": "All Languages",
    "description_th": "รับตัวเลข 2 ตัว คั่นด้วยช่องว่าง \nจงหา ห.ร.ม. (GCD) และ ค.ร.น. (LCM) ของสองจำนวนนี้ ปริ้นท์คั่นด้วยช่องว่าง",
    "description_en": "Calculate the Greatest Common Divisor (GCD) and Least Common Multiple (LCM) of two numbers.",
    "hint_th": "ใช้ Euclidean Algorithm หา ห.ร.ม. ก่อน แล้ว ค.ร.น. จะเท่ากับ (a*b)/ห.ร.ม.",
  ...
  },
  {
    ...
    "diff": "Hard",
    "lang": "All Languages",
    "description_th": "คุณมีเหรียญมูลค่า C1, C2, ... Cn \nจงหาจำนวนเหรียญน้อยที่สุดที่จะใช้ทอนเงินจำนวน V (ถ้าไม่สามารถทอนได้ให้ปริ้นท์ -1)\nบรรทัดแรก: V และ N\nบรรทัดสอง: มูลค่าเหรียญ N เหรียญ",
    "description_en": "Find the minimum number of coins needed to make amount V. Print -1 if impossible.",
  ...
  },
  {
    ...
    "diff": "Medium",
    "lang": "All Languages",
    "description_th": "ให้ตารางขนาด R x C โดย 1 แทนแผ่นดินและ 0 แทนน้ำ\nจงนับว่ามีเกาะกี่เกาะ (เกาะคือกลุ่มของแผ่นดินที่เชื่อมติดกันใน 4 ทิศทาง บนล่างซ้ายขวา)",
    "description_en": "Given an R x C grid of 1s (land) and 0s (water), count the number of islands.",
  ...
  },
  {
    ...
    "diff": "Easy",
    "lang": "All Languages",
    "description_th": "รับเลข N (1 ถึง 100) แล้วให้พิมพ์พีระมิดด้วยดอกจัน (*) ความสูง N ชั้น\nตัวอย่าง N=3:\n  *\n ***\n*****",
  ...
  },
  {
    ...
    "diff": "Medium",
    "lang": "All Languages",
    "description_th": "ปุ่มโทรศัพท์มือถือแบบเก่า แต่ละปุ่มมี 3-4 ตัวอักษร จงแปลงข้อความที่พิมพ์เป็นลำดับการกดปุ่ม (เช่น A = 2, B = 22, C = 222, Space = 0)\nข้อมูลรับเข้าเป็นข้อความ (Uppercase), จงปริ้นท์ลำดับตัวเลขที่ต้องกดโดยมีช่องว่างคั่น",
    "description_en": "Convert text into old-school mobile phone keypad keypresses.",
  ...
  },
  {
    ...
    "diff": "Easy",
    "lang": "All Languages",
    "description_th": "รับ N และ T (เป้าหมาย) จากนั้นรับตัวเลขที่ 'เรียงลำดับแล้ว' จำนวน N ตัว\nจงหา Index (เริ่มที่ 0) ของตัวเลข T ในอาเรย์ ถ้าไม่เจอให้ตอบ -1",
    "description_en": "Find the index of target T in a sorted array using Binary Search.",
  ...
  },
  {
    ...
    "diff": "Medium",
    "lang": "All Languages",
    "description_th": "รับข้อความ 1 บรรทัด จงสลับลำดับของคำในข้อความ (คำคั่นด้วยช่องว่าง)\nเช่น \"hello world\" กลายเป็น \"world hello\"",
  ...
  },
  {
    ...
    "diff": "Easy",
    "lang": "All Languages",
    "description_th": "มีบันได N ขั้น แต่ละก้าวสามารถเดินขึ้นได้ 1 ขั้น หรือ 2 ขั้น \nจงหาจำนวนวิธีทั้งหมดที่จะเดินขึ้นไปถึงขั้นที่ N",
    "description_en": "You are climbing a staircase of N steps. You can take 1 or 2 steps at a time. How many distinct ways can you climb to the top?",
    "hint_th": "ความสัมพันธ์คล้ายกับเลขฟีโบนัชชี: ways(N) = ways(N-1) + ways(N-2)",
  ...
  },
  {
    ...
    "diff": "Medium",
    "lang": "All Languages",
    "description_th": "รับ N จงหาว่า N! (N Factorial) เมื่อคำนวณออกมาแล้ว จะมีเลขศูนย์ลงท้ายกี่ตัว",
    "description_en": "Count the number of trailing zeroes in N!.",
    "hint_th": "จำนวนศูนย์ลงท้ายเท่ากับจำนวนครั้งที่ 5 หาร 1..N ลงตัว (N/5 + N/25 + N/125 + ...)",
  ...
  },
  {
    ...
    "diff": "Hard",
    "lang": "All Languages",
    "description_th": "กบกระโดดข้ามใบบัว โดยแต่ละใบมีพิกัด X เริ่มต้นจาก X=0 ไป X=L แต่ละครั้งกระโดดได้ไม่เกินระยะ K\nจงหาว่าต้องกระโดดน้อยที่สุดกี่ครั้งถึงจะข้ามไปถึงพิกัด >= L",
    "description_en": "Find minimum number of jumps to reach position >= L, where max jump distance is K.",
    "hint_th": "ใช้หลักการ Greedy: กระโดดให้ไกลที่สุดเท่าที่จะไกลได้ในแต่ละก้าว",
    "hint_en": "Use greedy approach: Always jump to the furthest possible pad within reach K.",
    "testcases": [
      {
        "input": "10 4 3\n1 3 6\n",
        "expected": "3\n"
