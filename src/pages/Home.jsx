  ...
  return (
    <div className="container">
      <div style={{ textAlign: "center", marginBottom: "3rem" }}>
        ...
        >
          Interactive problems from classic competitive programming platforms.
          Choose any problem, write code, and run Python instantly in your
          browser!
        </p>
      </div>
      ...
      >
        ...
        <button
          ...
          style={{
            borderColor: filter === "Easy" ? "var(--color-success)" : "",
            color: filter === "Easy" ? "#fff" : "var(--color-success)",
          }}
        >
          Easy
        </button>
        <button
          ...
          style={{
            borderColor: filter === "Medium" ? "var(--color-warning)" : "",
            color: filter === "Medium" ? "#fff" : "var(--color-warning)",
          }}
        >
          Medium
        </button>
        <button
          ...
          style={{
            borderColor: filter === "Hard" ? "var(--color-error)" : "",
            color: filter === "Hard" ? "#fff" : "var(--color-error)",
          }}
        >
          Hard
        </button>
          ...
          >
            ...
            >
              {problem.description_th ||
                "โจทย์ปัญหาการเขียนโปรแกรมที่จะท้าทายความสามารถของคุณ ลองแก้ปัญหานี้ดูสิ!"}
            </p>
            ...
            >
              ...
              >
                <PlayCircle size={18} />{" "}
                {problem.type === "quiz" ? "Take Quiz" : "Solve Problem"}
              </button>
            </Link>
          </div>
        ))}
