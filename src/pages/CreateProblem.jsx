...
export default function CreateProblem() {
  ...
  const handleSubmit = (e) => {
    ...
    const savedCustomProblems = JSON.parse(
    ...
    <div className="container" style={{ maxWidth: "800px" }}>
      ...
      <div className="card">
        ...
        >
          ...
          >
            <label
              style={{ color: "var(--color-text-main)", fontWeight: "bold" }}
            >
              ชื่อโจทย์ (Title)
            </label>
            <input
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      Input (ทิ้งว่างได้ถ้าไม่มี Input)
                    </label>
                    <textarea
                      value={tc.input}
                      onChange={(e) =>
                  ...
                  >
                    ...
                    >
                      Expected Output (สิ่งที่ต้องตอบกลับ)
                    </label>
                    <textarea
                      value={tc.expected}
                      onChange={(e) =>
