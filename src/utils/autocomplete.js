    ...
    provideCompletionItems: (model, position) => {
      ...
      const suggestions = [
        ...
        },
        {
          label: "map",
          kind: 15,
          insertText: "map<${1:int}, ${2:string}> ${3:m};",
          insertTextRules: rules,
          range,
        },
        {
          label: "unordered_map",
          kind: 15,
          insertText: "unordered_map<${1:int}, ${2:int}> ${3:um};",
          insertTextRules: rules,
          range,
        },
        {
    ...
    provideCompletionItems: (model, position) => {
      ...
      const suggestions = [
        ...
        },
        {
          label: "zip",
          kind: 3,
          insertText: "zip(${1:list1}, ${2:list2})",
          insertTextRules: rules,
          range,
        },
        {
        ...
        },
        {
          label: "insert",
          kind: 3,
          insertText: "insert(${1:index}, ${2:val})",
          insertTextRules: rules,
          range,
        },
        {
    ...
    provideCompletionItems: (model, position) => {
      ...
      const suggestions = [
        ...
        },
        {
          label: "souf",
          kind: 15,
          insertText: 'System.out.printf("${1:%d}\\\n", ${2:var});',
          insertTextRules: rules,
          range,
        },
        {
